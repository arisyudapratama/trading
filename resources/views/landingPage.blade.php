...
<head>
    ...
    <link href="{{ asset('public/template-olshop/lib/animate/animate.min.css') }}" rel="stylesheet">
    <link href="{{ asset('public/template-olshop/lib/owlcarousel/assets/owl.carousel.min.css') }}" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{ asset('public/template-olshop/css/style.css') }}" rel="stylesheet">
...
<body>
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a href="" class="text-decoration-none">
                    <span class="h1 text-uppercase text-warning bg-dark px-2">Ulive</span>
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <span class="h1 text-uppercase text-dark bg-light px-2">Ulive</span>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset('public/img/buku_revolusi.jpg') }}" alt="">
                            ...
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate" href="">Revolusi Saham Syariah</a>
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>Rp.123.000</h5>
                                    <h6 class="text-muted ml-2"><del>Rp.123.000</del></h6>
                                </div>
    ...
    <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            ...
            <div class="col-md-6 px-xl-0 text-center text-md-right">
                <img class="img-fluid" src="{{ asset('public/template-olshop/img/payments.png') }}" alt="">
            </div>
        </div>
    </div>
    <!-- Footer End -->
    ...
    <script src="{{ asset('public/template-olshop/lib/easing/easing.min.js') }}"></script>
    <script src="{{ asset('public/template-olshop/lib/owlcarousel/owl.carousel.min.js') }}"></script>

    <!-- Contact Javascript File -->
    <script src="{{ asset('public/template-olshop/mail/jqBootstrapValidation.min.js') }}"></script>
    <script src="{{ asset('public/template-olshop/mail/contact.js') }}"></script>

    <!-- Template Javascript -->
    <script src="{{ asset('public/template-olshop/js/main.js') }}"></script>
